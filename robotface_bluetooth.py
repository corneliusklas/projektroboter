...
print("Die Definition von 0 und 1 bezüglich der Ober- und Unterlippe wurden verändert, so dass 1 = hoch und 0 = runter ist. Die muss beim Bloototh-Modul noch angepasst werden.")
